...
\eQb
q &\mapsto_\phi^{-1}& (\dfrac{S^2-1}{S^2+1},\dfrac{2x_1}{S^2+1},...,\dfrac{2x_n}{S^2+1},
\dfrac{S^2-1}{S^2+1},\dfrac{P^2-1}{P^2+1},\dfrac{2y_1}{P^2+1},...,
\dfrac{2y_n}{P^2+1}) \\
&\mapsto_{f}& \dfrac{(S^2-1)(P^2-1)}{(S^2+1)(P^2+1)} + \sum_{j=1}^{n}
\dfrac{4x_j y_j}{(S^2+1)(P^2+1)}, \\
\eQe
